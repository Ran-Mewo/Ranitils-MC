...
//        #else
//        ModLoadingContext.get().registerExtensionPoint(ConfigScreenHandler.ConfigScreenFactory.class, () -> new ConfigScreenHandler.ConfigScreenFactory((BiFunction<Minecraft, Screen, Screen>) (minecraft, screen) -> AutoConfig.getConfigScreen(ModConfig.class, screen).get()));
//        #endif
//    }
//
//    @SubscribeEvent
